            ...
            <tr key={clinician.id} className="border-b border-gray-800 hover:bg-gray-900">
              <td className="px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground text-sm">{clinician.name}</div>
              ...
              <td className="px-4 py-3 text-sm text-foreground">{clinician.patients}</td>
              <td className="px-4 py-3 text-sm text-foreground">{clinician.referrals}</td>
