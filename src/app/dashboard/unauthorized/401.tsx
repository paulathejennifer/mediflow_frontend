      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-3xl font-bold text-white mb-4">
            Oops! <span className="text-primary">Unauthorized</span>
          </h1>
          <p className="text-gray-300 text-lg leading-relaxed">
            You don't have permission to access this page. Please contact your administrator or go back to the previous page.
          </p>
