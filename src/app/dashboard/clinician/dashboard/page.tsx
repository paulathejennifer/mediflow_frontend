  ...
  return (
    <div className="flex-1 space-y-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-foreground">Clinician Dashboard</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Manage patient referrals and treatment plans
          </p>
        </div>
      </div>
      ...
      <div className="mt-8">
        <Card className="bg-gray-900/60 backdrop-blur-md border border-border/50">
          ...
          <CardContent>
            <RecentReferralsTable referrals={mockReferralsData.slice(0, 5)} userRole="clinician" />
          </CardContent>
        </Card>
      </div>
    </div>
